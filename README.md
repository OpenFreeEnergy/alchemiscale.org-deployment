...
| [`openadmet`](deployments/openadmet) | —            | https://api.openadmet.alchemiscale.org | OpenADMET production use. Runs on its own host; migration to the cluster is not scheduled yet |
